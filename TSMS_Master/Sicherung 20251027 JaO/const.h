...
namespace tsms_config
{
	...
	static unsigned int NUM_STATIONS = 6;

	// devices
	static const unsigned int NUM_DEVICES = 5;
	...
	// measurements
	static const unsigned int NUM_MEASUREMENTS = 10;
	...
	enum eTelToUI {TEL_SETUP = 32, TEL_STATUS, TEL_LOT, TEL_COUNTER, TEL_MEAS_VALUE, 
		TEL_MACHINE, TEL_COMP_STATUS, TEL_USER_MSG };	// if you change this, you have to change same in ui too
	enum eTelFromUI { TEL_UI_IS_STARTED = 32, TEL_UI_INIT_RS232, TEL_UI_INIT_DB, TEL_UI_INIT_DEVICES, TEL_UI_INIT_IO };	// if you change this, you have to change same in ui too
